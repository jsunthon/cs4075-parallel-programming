/* File:     ex4.6_pth_pi_mutex.c
 *
 * Compile: gcc -g -Wall -o 4_2 4_2.c -lm -lpthread
   Run: ./4_2 2 100000
 * Purpose:  Estimate pi using series 
 *
 *              pi = 4*[1 - 1/3 + 1/5 - 1/7 + 1/9 - . . . ]
 *
 *           This is a modified version of pth_pi_mutex.  It uses a 
 *           semaphore to protect the critical section.
 *
 * Compile:  gcc -g -Wall -o ex4.6_pth_pi_mutex ex4.6_pth_pi_mutex.c 
 *                 -lm -lpthread
